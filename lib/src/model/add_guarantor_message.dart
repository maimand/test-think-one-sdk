...
part 'add_guarantor_message.g.dart';
...
/// * [relation] 
@BuiltValue()
abstract class AddGuarantorMessage implements Built<AddGuarantorMessage, AddGuarantorMessageBuilder> {
  ...
  AddGuarantorMessage._();

  factory AddGuarantorMessage([void updates(AddGuarantorMessageBuilder b)]) = _$AddGuarantorMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AddGuarantorMessageBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AddGuarantorMessage> get serializer => _$AddGuarantorMessageSerializer();
}

class _$AddGuarantorMessageSerializer implements PrimitiveSerializer<AddGuarantorMessage> {
  @override
  final Iterable<Type> types = const [AddGuarantorMessage, _$AddGuarantorMessage];

  @override
  final String wireName = r'AddGuarantorMessage';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AddGuarantorMessage object, {
  ...
  void _deserializeProperties(
    ...
    required AddGuarantorMessageBuilder result,
  ...
  @override
  AddGuarantorMessage deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AddGuarantorMessageBuilder();
